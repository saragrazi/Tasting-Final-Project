          ...
          <FormControlLabel
            ...
            label={
              <Typography variant="caption" sx={{ fontSize: "0.85rem", lineHeight: 1.4 }}>
                ידוע לי כי אין הנהלת האתר אחראית על תוכן הגולשים, וכי כל נזק לצד ג' או הפרת זכויות יוצרים באחריות הכותב בלבד. באחריותך לבדוק את זכויות היוצרים של כל תוכן, תמונה או קובץ וכו'.
              </Typography>
            }
          />
